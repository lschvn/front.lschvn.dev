...
- **Attack Modes**: Switch between Blitz, Siege, and Raid to tune how offensives trade speed, casualties, and infrastructure disruption
- **Alliance System**: Form alliances with other players for mutual defense
- **Operational Supply**: Frontline regions now care about encirclement, ports, factories, rail links, and naval blockade pressure
