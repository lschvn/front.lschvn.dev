...
import { ColoredTeams, GameMode, PlayerInfo, PlayerType, RankedType, } from "../../../src/core/game/Game";
...
describe("WinCheckExecution", () => {
    ...
    it("should call checkWinnerFFA in FFA mode", () => {
        const spy = vi.spyOn(winCheck, "checkWinnerFFA");
        winCheck.tick(10);
    ...
    it("should call checkWinnerTeam in non-FFA mode", () => {
        ...
        winCheck.init(mg, 0);
        const spy = vi.spyOn(winCheck, "checkWinnerTeam");
        winCheck.tick(10);
        expect(spy).toHaveBeenCalled();
    });
    ...
    it("should set winner in FFA if timer is 0", () => {
        ...
        const threshold = mg.config().numSpawnPhaseTurns() +
...
describe("WinCheckExecution - Nation Winners", () => {
    test("should set Nation as winner when reaching 80% territory", async () => {
        ...
        const nationInfo = new PlayerInfo("TestNation", PlayerType.Nation, null, "nation_id");
    ...
    test("should set Nation as winner when timer expires with most territory", async () => {
        ...
        // Create human player
        const humanInfo = new PlayerInfo("HumanPlayer", PlayerType.Human, null, "human_id");
        ...
        const threshold = game.config().numSpawnPhaseTurns() +
    ...
    test("should set correct Nation as winner among multiple Nations", async () => {
        ...
        const nation1Info = new PlayerInfo("Nation1", PlayerType.Nation, null, "nation1_id");
        game.addPlayer(nation1Info);
        const nation1 = game.player("nation1_id");
        const nation2Info = new PlayerInfo("Nation2", PlayerType.Nation, null, "nation2_id");
        game.addPlayer(nation2Info);
        const nation2 = game.player("nation2_id");
        const nation3Info = new PlayerInfo("Nation3", PlayerType.Nation, null, "nation3_id");
...
//# sourceMappingURL=WinCheckExecution.test.js.map