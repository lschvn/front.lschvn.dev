...
// Mock types
const createMockStation = (unitId) => {
...
describe("RailNetworkImpl", () => {
    ...
    describe("computeGhostRailPaths", () => {
        ...
        test("limits to at most 5 paths", () => {
            ...
            stationManager.findStation.mockImplementation((unit) => {
                const station = createMockStation(unit.id);
                station.tile.mockReturnValue(100 + unit.id);
                return station;
            });
            pathService.findTilePath.mockImplementation((_from, to) => [
                _from,
                to,
            ]);
...
//# sourceMappingURL=RailNetwork.test.js.map