...
describe("UniversalPathFinding.Parabola", () => {
    ...
    describe("findPath", () => {
        ...
        it("throws error for multiple start points", () => {
            ...
            const to = map.ref(90, 50);
            expect(() => finder.findPath(from, to)).toThrow("does not support multiple start points");
        });
    ...
    describe("next (stepping)", () => {
        ...
        it("respects speed parameter (higher speed = further movement)", () => {
            ...
            const node1 = result1.node;
            const node2 = result2.node;
...
//# sourceMappingURL=UniversalPathFinding.Parabola.test.js.map