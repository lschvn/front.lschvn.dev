...
describe("DeleteUnitExecution Security Tests", () => {
    ...
    beforeEach(async () => {
        ...
        const playerSpawn = game.ref(0, 10);
        const enemySpawn = game.ref(0, 15);
        game.addExecution(new SpawnExecution(gameID, game.player(player1Info.id).info(), playerSpawn), new SpawnExecution(gameID, game.player(player2Info.id).info(), enemySpawn));
...
//# sourceMappingURL=DeleteUnitExecution.test.js.map