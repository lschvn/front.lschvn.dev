...
import { MessageType, PlayerType } from "../src/core/game/Game";
...
describe("AllianceExtensionExecution", () => {
    ...
    test("Sends message to other player when one player requests renewal", () => {
        ...
        expect(displayMessageSpy).toHaveBeenCalledWith("events_display.wants_to_renew_alliance", MessageType.RENEW_ALLIANCE, player2.id(), undefined, { name: player1.displayName() });
...
//# sourceMappingURL=AllianceExtensionExecution.test.js.map