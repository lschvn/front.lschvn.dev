...
describe("FluentSlider", () => {
    ...
    beforeEach(async () => {
        ...
        slider = document.createElement("fluent-slider");
    ...
    describe("Value Validation via Number Input", () => {
        it("should clamp values to min", () => {
            ...
            if (testValue < slider.min)
                testValue = slider.min;
            if (testValue > slider.max)
                testValue = slider.max;
...
//# sourceMappingURL=FluentSlider.test.js.map