...
import { attackMenuElement, buildMenuElement, COLORS, rootMenuElement, Slot, } from "../../../src/client/graphics/layers/RadialMenuElements";
import { UnitType } from "../../../src/core/game/Game";
vi.mock("../../../src/client/Utils", () => ({
    translateText: vi.fn((key) => key),
    renderNumber: vi.fn((num) => num.toString()),
}));
vi.mock("../../../src/client/graphics/layers/BuildMenu", async () => {
    const { UnitType } = await vi.importActual("../../../src/core/game/Game");
    return {
        flattenedBuildTable: [
            {
...
describe("RadialMenuElements", () => {
    ...
    describe("attackMenuElement", () => {
        ...
        it("should handle undefined params in submenu", () => {
            const subMenu = attackMenuElement.subMenu(undefined);
    ...
    describe("buildMenuElement", () => {
        ...
        it("should handle undefined params in submenu", () => {
            const subMenu = buildMenuElement.subMenu(undefined);
            expect(subMenu).toEqual([]);
        });
    });
    ...
    describe("Translation integration", () => {
        it("should use translateText for tooltip items in build menu", async () => {
            const { translateText } = await vi.importMock("../../../src/client/Utils");
