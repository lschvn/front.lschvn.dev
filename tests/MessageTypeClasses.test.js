...
describe("getMessageTypeClasses", () => {
    ...
    it("should return a valid CSS class for every MessageType", () => {
        const messageTypes = Object.values(MessageType).filter((value) => typeof value === "number");
    ...
    it("should return white color and warn for unknown message types", () => {
        ...
        expect(consoleSpy).toHaveBeenCalledWith("Message type 999 has no explicit color");
    });
});
//# sourceMappingURL=MessageTypeClasses.test.js.map