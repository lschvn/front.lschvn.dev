...
vi.mock("../src/client/Utils", () => ({
    translateText: (key, vars) => vars ? `${key}:${JSON.stringify(vars)}` : key,
}));
import { MAX_USERNAME_LENGTH, validateUsername, } from "../src/core/validations/username";
...
//# sourceMappingURL=Censor.test.js.map