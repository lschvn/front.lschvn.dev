...
describe("PlayerImpl", () => {
    ...
    test("City can be upgraded from another city", () => {
        const city = player.buildUnit(UnitType.City, game.ref(0, 0), {});
        const cityToUpgrade = player.findUnitToUpgrade(UnitType.City, game.ref(0, 1));
    ...
    test("City cannot be upgraded when too far away", () => {
        ...
        const cityToUpgrade = player.findUnitToUpgrade(UnitType.City, game.ref(50, 50));
...
//# sourceMappingURL=PlayerImpl.test.js.map