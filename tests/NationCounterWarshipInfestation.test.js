...
import { Cell, Difficulty, GameMode, Nation, PlayerInfo, PlayerType, UnitType, } from "../src/core/game/Game";
...
describe("Counter Warship Infestation", () => {
    test("rich nation sends counter-warship in FFA when enemy has too many warships", async () => {
        ...
        const enemyInfo = new PlayerInfo("warship_spammer", PlayerType.Human, null, "enemy_id");
    ...
    test("rich nation sends counter-warship in Team game when enemy team has too many warships", async () => {
        ...
        const nationInfo = new PlayerInfo("[ALPHA]defender_nation", PlayerType.Nation, null, "nation_id");
        const allyInfo = new PlayerInfo("[ALPHA]ally_player", PlayerType.Human, null, "ally_id");
        const enemy1Info = new PlayerInfo("[BETA]enemy_player_1", PlayerType.Human, null, "enemy1_id");
        const enemy2Info = new PlayerInfo("[BETA]enemy_player_2", PlayerType.Human, null, "enemy2_id");
        const game = await setup("half_land_half_ocean", {
            infiniteGold: true,
            instantBuild: true,
            difficulty: Difficulty.Hard, // Required for counter-warship logic
        ...
        const totalEnemyTeamWarships = enemy1.units(UnitType.Warship).length +
...
//# sourceMappingURL=NationCounterWarshipInfestation.test.js.map