...
describe("Donate troops to an ally", () => {
    it("Troops should be successfully donated", async () => {
        ...
        const donorInfo = new PlayerInfo("donor", PlayerType.Human, null, "donor_id");
        const recipientInfo = new PlayerInfo("recipient", PlayerType.Human, null, "recipient_id");
        ...
        game.addExecution(new SpawnExecution(gameID, donorInfo, spawnA), new SpawnExecution(gameID, recipientInfo, spawnB));
...
//# sourceMappingURL=Donate.test.js.map