...
import { calculateStats, getAdapter, getScenario, measureExecutionTime, measurePathLength, printHeader, printRow, } from "../utils";
...
async function runScenario(adapterName, scenarioName, options = {}) {
