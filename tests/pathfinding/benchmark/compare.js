 ...
 */
import { calculateStats, getAdapter, getScenario, measureExecutionTime, measurePathLength, } from "../utils";
const DEFAULT_ITERATIONS = 1;
async function runBenchmark(scenarioName, adapterName) {
...
function printTableHeader(scenarioName) {
