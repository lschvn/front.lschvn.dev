...
import { Cell, Difficulty, Nation, PlayerInfo, PlayerType, UnitType, } from "../src/core/game/Game";
...
describe("NationNukeBehavior - maybeDestroyEnemySam", () => {
    test("nation overwhelms enemy SAM with atom bomb salvo on Impossible difficulty", async () => {
        ...
        nation.addTroops(100000);
        human.addTroops(100000);
...
//# sourceMappingURL=NationNukeSamOverwhelm.test.js.map