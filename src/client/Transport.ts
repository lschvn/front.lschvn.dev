...
export class SendAttackIntentEvent implements GameEvent {
  constructor(
    ...
    public readonly mode: AttackMode,
  ) {}
}
...
export class ProduceAirSquadronIntentEvent implements GameEvent {
  constructor(
    public readonly airbaseId: number,
    public readonly squadronType: UnitType.FighterSquadron | UnitType.BomberSquadron,
  ) {}
}

export class LaunchAirMissionIntentEvent implements GameEvent {
  constructor(
    public readonly airbaseId: number,
    public readonly squadronType: UnitType.FighterSquadron | UnitType.BomberSquadron,
    public readonly missionType: AirMissionType,
...
export class Transport {
  ...
  constructor(
    ...
    this.eventBus.on(ProduceAirSquadronIntentEvent, (e) =>
      this.onProduceAirSquadronIntent(e),
    );
    this.eventBus.on(LaunchAirMissionIntentEvent, (e) =>
      this.onLaunchAirMissionIntent(e),
    );
  ...
  private onProduceAirSquadronIntent(event: ProduceAirSquadronIntentEvent) {
    this.sendIntent({
  ...
  private onLaunchAirMissionIntent(event: LaunchAirMissionIntentEvent) {
    this.sendIntent({
