export class CrazyGamesSDK {
    ...
    async addAuthListener(listener) {
        if (!(await this.ready())) {
            return;
        }
        try {
...
//# sourceMappingURL=CrazyGamesSDK.js.map