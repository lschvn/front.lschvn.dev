...
import { PROCEDURAL_DEFAULT_NATIONS } from "../core/game/ProceduralMegaWorldConstants";
...
import {
  ...
  getRandomMapType,
  defaultProceduralWorldConfig,
  getUpdatedDisabledUnits,
  isProceduralMegaWorld,
  maxBotsForMap,
  maxNationsForMap,
...
export class SinglePlayerModal extends BaseModal {
  ...
  @state() private proceduralWorld: ProceduralWorldConfig =
    defaultProceduralWorldConfig();
      ...
      <div class="${this.modalContainerClass}">
        ...
        >
          <game-config-settings
            ...
            .settings=${{
              ...
              options: {
                ...
                bots: {
                  ...
                  maxValue: maxBotsForMap(this.selectedMap),
                },
                nations: {
                  value: this.nations,
                  ...
                  maxValue: maxNationsForMap(this.selectedMap),
                },
                toggles: [
                  {
              ...
              procedural: {
                visible: isProceduralMegaWorld(this.selectedMap),
                seed: this.proceduralWorld.seed,
                worldSizePreset: this.proceduralWorld.worldSizePreset,
                landmassStyle: this.proceduralWorld.landmassStyle,
                performancePreset: this.proceduralWorld.performancePreset,
                warningKey: "map.procedural_extreme_warning",
              },
              unitTypes: {
            ...
            @procedural-seed-changed=${this.handleProceduralSeedChanged}
            @procedural-random-seed=${this.handleProceduralRandomSeed}
            @procedural-world-size-changed=${this.handleProceduralWorldSizeChanged}
            @procedural-landmass-style-changed=${this
              .handleProceduralLandmassStyleChanged}
            @procedural-performance-preset-changed=${this
              .handleProceduralPerformancePresetChanged}
          ></game-config-settings>
        </div>
  ...
  protected onClose(): void {
    ...
    this.proceduralWorld = defaultProceduralWorldConfig();
  }
  ...
  private handleMapSelection(value: GameMapType) {
    ...
    this.bots = Math.min(this.bots, maxBotsForMap(value));
    this.nations = Math.min(this.nations, maxNationsForMap(value));
    if (isProceduralMegaWorld(value) && !this.proceduralWorld.seed) {
      this.proceduralWorld = {
        ...this.proceduralWorld,
        seed: proceduralRandomSeed(),
      };
    }
    void this.loadNationCount();
  }
  ...
  private handleProceduralSeedChanged = (e: Event) => {
    const customEvent = e as CustomEvent<{ seed: string }>;
    this.proceduralWorld = {
      ...this.proceduralWorld,
      seed: customEvent.detail.seed || this.proceduralWorld.seed,
    };
  };
  ...
  private handleProceduralWorldSizeChanged = (e: Event) => {
    const customEvent = e as CustomEvent<{
      worldSizePreset: ProceduralWorldSizePreset;
    }>;
    this.proceduralWorld = {
      ...this.proceduralWorld,
      worldSizePreset: customEvent.detail.worldSizePreset,
    };
  };

  private handleProceduralLandmassStyleChanged = (e: Event) => {
    const customEvent = e as CustomEvent<{
      landmassStyle: ProceduralLandmassStyle;
    }>;
    this.proceduralWorld = {
      ...this.proceduralWorld,
      landmassStyle: customEvent.detail.landmassStyle,
    };
  };

  private handleProceduralPerformancePresetChanged = (e: Event) => {
    const customEvent = e as CustomEvent<{
      performancePreset: ProceduralPerformancePreset;
    }>;
    this.proceduralWorld = {
      ...this.proceduralWorld,
      performancePreset: customEvent.detail.performancePreset,
    };
    if (isProceduralMegaWorld(this.selectedMap)) {
      this.defaultNationCount =
        PROCEDURAL_DEFAULT_NATIONS[this.proceduralWorld.performancePreset];
      this.nations = this.defaultNationCount;
    }
  };
  ...
  private handleBotsChange = (e: Event) => {
    ...
    const maxBots = maxBotsForMap(this.selectedMap);
  ...
  private handleNationsChange = (e: Event) => {
    const customEvent = e as CustomEvent<{ value: number }>;
    const value = customEvent.detail.value;
    const maxNations = maxNationsForMap(this.selectedMap);
    if (isNaN(value) || value < 0 || value > maxNations) {
      return;
    }
    this.nations = value;
  };
          ...
          gameStartInfo: {
            ...
            config: {
              ...
              ...(this.startingGold && this.startingGoldValue !== undefined
                ...
                : {}),
              ...(isProceduralMegaWorld(this.selectedMap)
                ? { proceduralWorld: this.proceduralWorld }
                : {}),
            },
  ...
  private async loadNationCount() {
    ...
    if (isProceduralMegaWorld(currentMap)) {
      this.defaultNationCount =
        PROCEDURAL_DEFAULT_NATIONS[this.proceduralWorld.performancePreset];
      this.nations = this.defaultNationCount;
      return;
