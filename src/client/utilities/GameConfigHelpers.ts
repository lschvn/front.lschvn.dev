...
import {
  PROCEDURAL_MEGA_WORLD_MAX_BOTS,
  PROCEDURAL_MEGA_WORLD_MAX_NATIONS,
} from "../../core/game/ProceduralMegaWorldConstants";
...
export function isProceduralMegaWorld(map: GameMapType): boolean {
  return map === GameMapType.ProceduralMegaWorld;
}

export function maxBotsForMap(map: GameMapType): number {
  return isProceduralMegaWorld(map) ? PROCEDURAL_MEGA_WORLD_MAX_BOTS : 400;
}

export function maxNationsForMap(map: GameMapType): number {
  return isProceduralMegaWorld(map) ? PROCEDURAL_MEGA_WORLD_MAX_NATIONS : 400;
}

export function proceduralRandomSeed(): string {
...
export function defaultProceduralWorldConfig(): ProceduralWorldConfig {
  return {
