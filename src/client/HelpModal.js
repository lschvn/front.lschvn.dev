...
let HelpModal = class HelpModal extends BaseModal {
    constructor() {
        super(...arguments);
            ...
            <div class="pt-2 pb-4 px-4 overflow-x-auto">
              <table class="w-full text-sm border-separate border-spacing-y-1">
                ...
                <tbody class="text-white/80">
                  ...
                  <tr class="hover:bg-white/5 transition-colors">
                    <td class="py-3 pl-4 border-b border-white/5">
                      ${this.renderKey(keybinds.attackModeCycle)}
                    </td>
                    <td class="py-3 border-b border-white/5 text-white/70">
                      Cycle attack mode
                    </td>
    ...
    openTroubleshooting() {
        const troubleshootingModal = document.querySelector("troubleshooting-modal");
...
__decorate([
    state()
], HelpModal.prototype, "keybinds", void 0);
__decorate([
    query("#tutorial-video-iframe")
], HelpModal.prototype, "videoIframe", void 0);
