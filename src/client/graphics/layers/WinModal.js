...
import { getGamesPlayed, isInIframe, translateText, TUTORIAL_VIDEO_URL, } from "../../../client/Utils";
import { RankedType } from "../../../core/game/Game";
import { GameUpdateType } from "../../../core/game/GameUpdates";
import { getUserMe } from "../../Api";
import "../../components/PatternButton";
import { fetchCosmetics, handlePurchase, patternRelationship, } from "../../Cosmetics";
import { crazyGamesSDK } from "../../CrazyGamesSDK";
import { Platform } from "../../Platform";
import { SendWinnerEvent } from "../../Transport";
let WinModal = class WinModal extends LitElement {
    ...
    async loadPatternContent() {
        ...
        for (const pattern of Object.values(patterns?.patterns ?? {})) {
            for (const colorPalette of pattern.colorPalettes ?? []) {
                if (patternRelationship(pattern, colorPalette, me, null) === "purchasable") {
        ...
        const selectedPatterns = shuffled.slice(0, Math.min(maxPatterns, shuffled.length));
        this.patternContent = html `
      <div class="flex gap-4 flex-wrap justify-start">
        ${selectedPatterns.map(({ pattern, colorPalette }) => html `
            <pattern-button
              .pattern=${pattern}
        ...
        winUpdates.forEach((wu) => {
            if (wu.winner === undefined) {
                ...
                if (winnerClient !== null) {
                    this.eventBus.emit(new SendWinnerEvent(["player", winnerClient], wu.allPlayersStats));
                }
                if (winnerClient !== null &&
...
__decorate([
    state()
], WinModal.prototype, "isVisible", void 0);
__decorate([
    state()
], WinModal.prototype, "showButtons", void 0);
__decorate([
    state()
], WinModal.prototype, "isWin", void 0);
__decorate([
    state()
], WinModal.prototype, "isRankedGame", void 0);
__decorate([
    state()
], WinModal.prototype, "patternContent", void 0);
WinModal = __decorate([
