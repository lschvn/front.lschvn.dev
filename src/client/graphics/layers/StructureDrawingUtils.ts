...
import sonarStationIcon from "/images/SonarStationUnit.svg?url";
import targetIcon from "/images/TargetIconWhite.svg?url";
import { SONAR_STATION_REVEAL_RADIUS } from "../../../core/configuration/NavalStealthBalance";
...
export const STRUCTURE_SHAPES: Partial<Record<UnitType, ShapeType>> = {
  ...
  [UnitType.SonarStation]: "circle",
  [UnitType.AABattery]: "octagon",
  [UnitType.RadarStation]: "pentagon",
...
export class SpriteFactory {
  ...
  > = new Map([
    ...
    [UnitType.SonarStation, { iconPath: sonarStationIcon, image: null }],
    [UnitType.AABattery, { iconPath: shieldIcon, image: null }],
    [UnitType.RadarStation, { iconPath: targetIcon, image: null }],
  ]);
  constructor(
    theme: Theme,
    game: GameView,
  ...
  public createRange(
    ...
    switch (type) {
      ...
      case UnitType.SonarStation:
        radius = SONAR_STATION_REVEAL_RADIUS;
        break;
      case UnitType.AABattery:
        radius = this.game.config().aaBatteryRange();
        break;
      case UnitType.RadarStation:
        radius = this.game.config().radarStationRange();
        break;
