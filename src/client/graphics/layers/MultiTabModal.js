...
let MultiTabModal = class MultiTabModal extends LitElement {
    constructor() {
        super(...arguments);
        this.duration = 5000;
        this.countdown = 5;
    ...
    tick() {
        ...
        if (!this.detector) {
            ...
            this.detector.startMonitoring((duration) => {
                this.show(duration);
            });
        }
    }
    ...
    hide() {
        ...
        this.dispatchEvent(new CustomEvent("penalty-complete", {
            bubbles: true,
            composed: true,
        }));
        this.requestUpdate();
...
], MultiTabModal.prototype, "duration", void 0);
__decorate([
    state()
], MultiTabModal.prototype, "countdown", void 0);
__decorate([
    state()
], MultiTabModal.prototype, "isVisible", void 0);
__decorate([
    state()
], MultiTabModal.prototype, "fakeIp", void 0);
__decorate([
    state()
], MultiTabModal.prototype, "deviceFingerprint", void 0);
__decorate([
    state()
], MultiTabModal.prototype, "reported", void 0);
MultiTabModal = __decorate([
    customElement("multi-tab-modal")
], MultiTabModal);
export { MultiTabModal };
//# sourceMappingURL=MultiTabModal.js.map