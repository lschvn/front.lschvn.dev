...
import { ContextMenuEvent, MouseMoveEvent, TouchEvent, } from "../../InputHandler";
...
function euclideanDistWorld(coord, tileRef, game) {
...
function distSortUnitWorld(coord, game) {
    return (a, b) => {
...
let PlayerInfoOverlay = class PlayerInfoOverlay extends LitElement {
    constructor() {
        super(...arguments);
        this.player = null;
    ...
    init() {
        ...
        this.eventBus.on(ContextMenuEvent, (e) => this.maybeShow(e.x, e.y));
        this.eventBus.on(TouchEvent, (e) => this.maybeShow(e.x, e.y));
    ...
    getPlayerNameColor(player, myPlayer, isFriendly) {
        if (isFriendly)
    ...
    displayUnitCount(player, type, icon) {
    ...
    allianceExpirationText(alliance) {
    ...
    renderPlayerNameIcons(player) {
      ...
      ${icons.map((icon) => icon.kind === "emoji" && icon.text
    ...
    renderPlayerInfo(player) {
      ...
      <div class="flex items-start gap-2 lg:gap-3 p-1.5 lg:p-2">
        ...
        <div class="flex flex-col justify-between self-stretch">
          <div
            class="flex items-center gap-2 font-bold text-sm lg:text-lg ${this.getPlayerNameColor(player, myPlayer, isFriendly ?? false)}"
          >
    ...
    renderUnitInfo(unit) {
        const isAlly = (unit.owner() === this.game.myPlayer() ||
...
], PlayerInfoOverlay.prototype, "game", void 0);
__decorate([
    property({ type: Object })
], PlayerInfoOverlay.prototype, "eventBus", void 0);
__decorate([
    property({ type: Object })
], PlayerInfoOverlay.prototype, "transform", void 0);
__decorate([
    state()
], PlayerInfoOverlay.prototype, "player", void 0);
__decorate([
    state()
], PlayerInfoOverlay.prototype, "playerProfile", void 0);
__decorate([
    state()
], PlayerInfoOverlay.prototype, "unit", void 0);
__decorate([
    state()
], PlayerInfoOverlay.prototype, "_isInfoVisible", void 0);
__decorate([
    state()
], PlayerInfoOverlay.prototype, "spawnBarVisible", void 0);
__decorate([
    state()
], PlayerInfoOverlay.prototype, "immunityBarVisible", void 0);
PlayerInfoOverlay = __decorate([
    customElement("player-info-overlay")
], PlayerInfoOverlay);
export { PlayerInfoOverlay };
//# sourceMappingURL=PlayerInfoOverlay.js.map