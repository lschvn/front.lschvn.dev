...
export class GoToPlayerEvent {
    constructor(player) {
        this.player = player;
    }
}
export class GoToPositionEvent {
    constructor(x, y) {
        this.x = x;
        this.y = y;
    }
}
export class GoToUnitEvent {
    constructor(unit) {
        this.unit = unit;
    }
}
let Leaderboard = class Leaderboard extends LitElement {
    ...
    updateLeaderboard() {
        ...
        const compare = (a, b) => this._sortOrder === "asc" ? a - b : b - a;
        const maxTroops = (p) => this.game.config().maxTroops(p);
        switch (this._sortKey) {
            case "gold":
                sorted = sorted.sort((a, b) => compare(Number(a.gold()), Number(b.gold())));
                break;
            case "maxtroops":
...
], Leaderboard.prototype, "visible", void 0);
__decorate([
    state()
], Leaderboard.prototype, "_sortKey", void 0);
__decorate([
    state()
], Leaderboard.prototype, "_sortOrder", void 0);
