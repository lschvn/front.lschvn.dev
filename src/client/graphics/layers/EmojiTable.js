...
let EmojiTable = class EmojiTable extends LitElement {
    constructor() {
        super(...arguments);
        this.isVisible = false;
        this.onEmojiClicked = () => { };
        this.handleBackdropClick = (e) => {
            const panelContent = this.querySelector('div[class*="bg-zinc-900"]');
    ...
    initEventBus(eventBus) {
        eventBus.on(ShowEmojiMenuEvent, (e) => {
            ...
            this.showTable((emoji) => {
                const recipient = targetPlayer === this.game.myPlayer()
                    ? AllPlayers
                    : targetPlayer;
                eventBus.emit(new SendEmojiIntentEvent(recipient, flattenedEmojiTable.indexOf(emoji)));
                this.hideTable();
            });
        });
        ...
        <div class="relative">
          ...
          >
            <div class="grid grid-cols-5 gap-1 sm:gap-2">
              ${flattenedEmojiTable.map((emoji) => html `
                  <button
...
__decorate([
    state()
], EmojiTable.prototype, "isVisible", void 0);
EmojiTable = __decorate([
    customElement("emoji-table")
], EmojiTable);
export { EmojiTable };
//# sourceMappingURL=EmojiTable.js.map