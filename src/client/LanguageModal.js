...
let LanguageModal = class LanguageModal extends BaseModal {
    constructor() {
        super(...arguments);
        this.languageList = [];
        this.currentLang = "en";
      ...
      >
        ...
        >
          ...
          >
            ...
            let buttonClasses = "relative group rounded-xl border transition-all duration-200 flex items-center p-3 gap-3 w-full cursor-pointer";
            if (isDebug) {
                buttonClasses +=
...
__decorate([
    property({ type: Array })
], LanguageModal.prototype, "languageList", void 0);
__decorate([
    property({ type: String })
], LanguageModal.prototype, "currentLang", void 0);
LanguageModal = __decorate([
