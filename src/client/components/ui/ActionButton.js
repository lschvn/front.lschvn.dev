...
const ICON_SIZE = "h-5 w-5 shrink-0 transition-transform group-hover:scale-110 text-zinc-400";
const TEXT_SIZE = "text-base sm:text-[14px] leading-5 font-semibold tracking-tight";
const getButtonStyles = () => {
    const btnBase = "group w-full min-w-[50px] select-none flex flex-col items-center justify-center " +
...
export const actionButton = (props) => {
    const { onClick, type = "normal", icon, iconAlt, title, label, disabled = false, } = props;
