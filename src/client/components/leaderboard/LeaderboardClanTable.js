...
let LeaderboardClanTable = class LeaderboardClanTable extends LitElement {
    constructor() {
        super(...arguments);
        this.clanData = null;
    ...
    async loadClanLeaderboard() {
        this.isLoading = true;
        this.error = null;
        try {
            const data = await fetchClanLeaderboard();
            if (!data)
                throw new Error("Failed to load clan leaderboard");
            this.clanData = data;
            this.hasLoaded = true;
...
__decorate([
    state()
], LeaderboardClanTable.prototype, "clanData", void 0);
__decorate([
    state()
], LeaderboardClanTable.prototype, "isLoading", void 0);
__decorate([
    state()
], LeaderboardClanTable.prototype, "error", void 0);
__decorate([
    state()
], LeaderboardClanTable.prototype, "sortBy", void 0);
__decorate([
    state()
], LeaderboardClanTable.prototype, "sortOrder", void 0);
LeaderboardClanTable = __decorate([
    customElement("leaderboard-clan-table")
], LeaderboardClanTable);
export { LeaderboardClanTable };
//# sourceMappingURL=LeaderboardClanTable.js.map