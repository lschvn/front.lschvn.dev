...
let CopyButton = class CopyButton extends LitElement {
    constructor() {
        ...
        this.maskLabel = html `&bull;&bull;&bull;&bull;&bull;&bull;&bull;&bull;`;
    }
    createRenderRoot() {
        return this;
    }
    willUpdate(changedProperties) {
        if (changedProperties.has("lobbyId")) {
            this.lobbyIdVisible = this.userSettings.get("settings.lobbyIdVisibility", true);
            this.copySuccess = false;
        }
        if (changedProperties.has("copyText")) {
            this.copySuccess = false;
        }
        if (changedProperties.has("showVisibilityToggle") ||
    ...
    enableSelectAll(e) {
        e.currentTarget.classList.add("select-all");
    }
    clearSelectAll(e) {
        e.currentTarget.classList.remove("select-all");
    }
    async buildCopyUrl() {
    ...
    async handleCopy() {
        ...
        await copyToClipboard(text, () => (this.copySuccess = true), () => (this.copySuccess = false));
    }
    canCopy() {
...
__decorate([
    property({ type: String, attribute: "lobby-id" })
], CopyButton.prototype, "lobbyId", void 0);
__decorate([
    property({ type: String, attribute: "lobby-suffix" })
], CopyButton.prototype, "lobbySuffix", void 0);
__decorate([
    property({ type: Boolean, attribute: "include-lobby-query" })
], CopyButton.prototype, "includeLobbyQuery", void 0);
__decorate([
    property({ type: String, attribute: "copy-text" })
], CopyButton.prototype, "copyText", void 0);
__decorate([
    property({ type: String, attribute: "display-text" })
], CopyButton.prototype, "displayText", void 0);
__decorate([
    property({ type: Boolean, attribute: "show-visibility-toggle" })
], CopyButton.prototype, "showVisibilityToggle", void 0);
__decorate([
    property({ type: Boolean, attribute: "show-copy-icon" })
], CopyButton.prototype, "showCopyIcon", void 0);
__decorate([
    property({ type: Boolean })
], CopyButton.prototype, "compact", void 0);
__decorate([
    state()
], CopyButton.prototype, "copySuccess", void 0);
__decorate([
    state()
], CopyButton.prototype, "lobbyIdVisible", void 0);
