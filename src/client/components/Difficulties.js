...
let DifficultyDisplay = class DifficultyDisplay extends LitElement {
    constructor() {
        super(...arguments);
        this.difficultyKey = "";
    }
    ...
    >
      ...
      ></path>
        ...
        const activeClass = "opacity-100 text-[#ff3838] drop-shadow-[0_0_4px_rgba(255,56,56,0.4)] transform group-hover:drop-shadow-[0_0_6px_rgba(255,56,56,0.6)] group-hover:-translate-y-[2px] -translate-y-[1px] transition-all duration-200";
...
], DifficultyDisplay.prototype, "difficultyKey", void 0);
DifficultyDisplay = __decorate([
    customElement("difficulty-display")
], DifficultyDisplay);
export { DifficultyDisplay };
