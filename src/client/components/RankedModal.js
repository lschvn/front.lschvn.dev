...
let RankedModal = class RankedModal extends BaseModal {
    constructor() {
        super();
        this.elo = "...";
      ...
      <div class="${this.modalContainerClass}">
        ...
        <div class="flex-1 min-h-0 overflow-y-auto custom-scrollbar p-6">
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ${this.renderCard(translateText("mode_selector.ranked_1v1_title"), this.errorMessage ??
            (hasLinkedAccount(this.userMeResponse)
                ? translateText("matchmaking_modal.elo", { elo: this.elo })
                : translateText("mode_selector.ranked_title")), () => this.handleRanked())}
            ${this.renderDisabledCard(translateText("mode_selector.ranked_2v2_title"), translateText("mode_selector.coming_soon"))}
            ${this.renderDisabledCard(translateText("mode_selector.coming_soon"), "")}
            ${this.renderDisabledCard(translateText("mode_selector.coming_soon"), "")}
          </div>
        </div>
      </div>
    ...
    renderCard(title, subtitle, onClick) {
        return html `
      <button
        @click=${onClick}
    ...
    renderDisabledCard(title, subtitle) {
        return html `
      <div
...
__decorate([
    state()
], RankedModal.prototype, "elo", void 0);
__decorate([
    state()
], RankedModal.prototype, "userMeResponse", void 0);
__decorate([
    state()
], RankedModal.prototype, "errorMessage", void 0);
RankedModal = __decorate([
    customElement("ranked-modal")
], RankedModal);
export { RankedModal };
//# sourceMappingURL=RankedModal.js.map