...
let MapPicker = class MapPicker extends LitElement {
    constructor() {
        super(...arguments);
        this.selectedMap = GameMapType.World;
        this.useRandomMap = false;
        this.showMedals = false;
        this.randomMapDivider = false;
    ...
    renderMapCard(mapValue) {
        const mapKey = Object.entries(GameMapType).find(([_, value]) => value === mapValue)?.[0];
        return html `
      <div
...
], MapPicker.prototype, "selectedMap", void 0);
__decorate([
    property({ type: Boolean })
], MapPicker.prototype, "useRandomMap", void 0);
__decorate([
    property({ type: Boolean })
], MapPicker.prototype, "showMedals", void 0);
__decorate([
    property({ type: Boolean })
], MapPicker.prototype, "randomMapDivider", void 0);
__decorate([
    property({ attribute: false })
], MapPicker.prototype, "mapWins", void 0);
__decorate([
    property({ attribute: false })
], MapPicker.prototype, "onSelectMap", void 0);
__decorate([
    property({ attribute: false })
], MapPicker.prototype, "onSelectRandom", void 0);
__decorate([
    state()
], MapPicker.prototype, "showAllMaps", void 0);
MapPicker = __decorate([
    customElement("map-picker")
], MapPicker);
export { MapPicker };
//# sourceMappingURL=MapPicker.js.map