...
let SettingToggle = class SettingToggle extends LitElement {
    constructor() {
        super(...arguments);
        this.label = "Setting";
        this.description = "";
...
__decorate([
    property()
], SettingToggle.prototype, "label", void 0);
__decorate([
    property()
], SettingToggle.prototype, "description", void 0);
__decorate([
    property()
], SettingToggle.prototype, "id", void 0);
__decorate([
    property({ type: Boolean, reflect: true })
], SettingToggle.prototype, "checked", void 0);
__decorate([
    property({ type: Boolean })
], SettingToggle.prototype, "easter", void 0);
SettingToggle = __decorate([
