...
let SettingKeybind = class SettingKeybind extends LitElement {
    constructor() {
        super(...arguments);
        this.label = "Setting";
        this.description = "";
...
__decorate([
    property()
], SettingKeybind.prototype, "label", void 0);
__decorate([
    property()
], SettingKeybind.prototype, "description", void 0);
__decorate([
    property({ type: String, reflect: true })
], SettingKeybind.prototype, "action", void 0);
__decorate([
    property({ type: String })
], SettingKeybind.prototype, "defaultKey", void 0);
__decorate([
    property({ type: String })
], SettingKeybind.prototype, "value", void 0);
__decorate([
    property({ type: String })
], SettingKeybind.prototype, "display", void 0);
__decorate([
    property({ type: Boolean })
], SettingKeybind.prototype, "easter", void 0);
SettingKeybind = __decorate([
    customElement("setting-keybind")
], SettingKeybind);
export { SettingKeybind };
//# sourceMappingURL=SettingKeybind.js.map