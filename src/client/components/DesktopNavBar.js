...
let DesktopNavBar = class DesktopNavBar extends LitElement {
    constructor() {
        super(...arguments);
        this._notifications = new NavNotificationsController(this);
        this._onShowPage = (e) => {
    ...
    render() {
        window.currentPageId ?? (window.currentPageId = "page-play");
