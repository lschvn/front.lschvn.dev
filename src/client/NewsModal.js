...
let NewsModal = class NewsModal extends BaseModal {
    constructor() {
        super(...arguments);
...
], NewsModal.prototype, "markdown", void 0);
NewsModal = __decorate([
    customElement("news-modal")
], NewsModal);
export { NewsModal };
let NewsButton = class NewsButton extends LitElement {
    connectedCallback() {
...
__decorate([
    query("news-modal")
], NewsButton.prototype, "newsModal", void 0);
NewsButton = __decorate([
    customElement("news-button")
], NewsButton);
export { NewsButton };
//# sourceMappingURL=NewsModal.js.map