export function initNavigation() {
    ...
    document.addEventListener("click", (e) => {
        const target = e.target.closest(".nav-menu-item[data-page]");
        if (target) {
            ...
            mainEl.addEventListener("click", (e) => {
                ...
                if (isPlayPageHidden) {
                    ...
                    if (isOnMain || isOnPageContent) {
                        ...
                        const openModal = document.querySelector(".page-content:not(.hidden)");
                        if (openModal && typeof openModal.close === "function") {
                            // Check confirmation guard before closing
                            if (typeof openModal.confirmBeforeClose === "function" &&
