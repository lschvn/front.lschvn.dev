...
import { z } from "zod";
import { TokenPayloadSchema, UserMeResponseSchema, } from "../core/ApiSchemas";
import { GameEnv } from "../core/configuration/Config";
import { PersistentIdSchema } from "../core/Schemas";
export async function verifyClientToken(token, config) {
...
export async function getUserMe(token, config) {
    try {
        // Get the user object
