...
if (config.otelEnabled()) {
    ...
    console.log("No OTLP endpoint and credentials provided, remote logging disabled");
}
...
const logger = winston.createLogger({
    level: "info",
    format: winston.format.combine(winston.format.timestamp(), addSeverityFormat(), winston.format.json()),
    defaultMeta: {
        service: "openfront",
