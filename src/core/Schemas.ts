...
export type Intent =
  ...
  | DonateTroopsIntent
  | BuildUnitIntent
  | ProduceAirSquadronIntent
  | LaunchAirMissionIntent
  | EmbargoIntent
  | QuickChatIntent
  | MoveWarshipIntent
...
export type ProduceAirSquadronIntent = z.infer<
  typeof ProduceAirSquadronIntentSchema
>;
export type LaunchAirMissionIntent = z.infer<
  typeof LaunchAirMissionIntentSchema
>;
...
export const ServerPrestartMessageSchema = z.object({
  ...
  gameMap: z.enum(GameMapType),
  gameMapSize: z.enum(GameMapSize),
  proceduralWorld: GameConfigSchema.shape.proceduralWorld,
});
