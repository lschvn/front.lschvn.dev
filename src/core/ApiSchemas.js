...
export const TokenPayloadSchema = z.object({
    ...
    sub: z
        ...
        const uuid = base64urlToUuid(val);
        if (!uuid)
            throw new Error("Invalid base64 UUID");
        return uuid;
    }),
    iat: z.number(),
    iss: z.string(),
...
export const PlayerStatsTreeSchema = z.partialRecord(z.enum(GameType), z.partialRecord(z.enum(GameMode), z.partialRecord(z.enum(Difficulty), PlayerStatsLeafSchema)));
