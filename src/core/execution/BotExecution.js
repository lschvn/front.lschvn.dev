...
export class BotExecution {
    ...
    tick(ticks) {
        ...
        if (this.attackBehavior === null) {
            this.attackBehavior = new AiAttackBehavior(this.random, this.mg, this.bot, this.triggerRatio, this.reserveRatio, this.expandRatio);
    ...
    acceptAllAllianceRequests() {
        ...
        for (const alliance of this.bot.alliances()) {
            ...
            this.mg.addExecution(new AllianceExtensionExecution(this.bot, human.id()));
        }
    }
    deleteAllStructures() {
...
//# sourceMappingURL=BotExecution.js.map