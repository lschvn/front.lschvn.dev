...
export class Executor {
    ...
    createExec(intent) {
        ...
        switch (intent.type) {
            case "attack": {
                return new AttackExecution(intent.troops, player, intent.targetID, null, true, intent.mode);
            }
            case "cancel_attack":
            ...
            case "boat":
                return new TransportShipExecution(player, intent.dst, intent.troops, intent.mode);
            ...
            case "donate_troops":
                return new DonateTroopsExecution(player, intent.recipient, intent.troops);
            case "donate_gold":
            ...
            case "build_unit":
                return new ConstructionExecution(player, intent.unit, intent.tile, intent.rocketDirectionUp);
            case "produce_air_squadron":
                return new ProduceAirSquadronExecution(player, intent.airbaseId, intent.squadronType);
            case "launch_air_mission":
                return new LaunchAirMissionExecution(player, intent.airbaseId, intent.squadronType, intent.missionType, intent.targetTile);
            ...
            case "quick_chat":
                return new QuickChatExecution(player, intent.recipient, intent.quickChatKey, intent.target);
