...
export class ConnectedComponents {
    constructor(map, accessTerrainDirectly = true) {
        this.map = map;
    ...
    initialize() {
        ...
        let ids = this.createPrefilledIds();
        let nextId = 0;
     ...
     */
    floodFillComponent(ids, start, componentId) {
        let head = 0;
        let tail = 0;
...
//# sourceMappingURL=ConnectedComponents.js.map