...
export class AStarWater {
    constructor(map, config) {
        ...
        this.maxIterations = config?.maxIterations ?? 1000000;
...
//# sourceMappingURL=AStar.Water.js.map