...
export class UnitImpl implements Unit {
  ...
  private _revealedUntilTick: Tick | undefined;
  ...
  private _airbaseId: number | undefined;
  private _airMissionType: AirMissionType | undefined;
  private _airMissionPhase: AirMissionPhase | undefined;
  private _airMissionTicksRemaining: Tick | undefined;
  private _rearmCompleteTick: Tick | undefined;
  ...
  constructor(
    ...
    this._rearmCompleteTick =
      "rearmCompleteTick" in params
        ...
        : undefined;
    this._revealedUntilTick =
      "revealedUntilTick" in params
        ? (params.revealedUntilTick ?? undefined)
        : undefined;
  ...
  setRevealedUntilTick(tick: Tick | undefined): void {
    if (this._revealedUntilTick !== tick) {
      this._revealedUntilTick = tick;
      this.mg.addUpdate(this.toUpdate());
    }
  }

  revealedUntilTick(): Tick | undefined {
    return this._revealedUntilTick;
  }
  ...
  toUpdate(): UnitUpdate {
    return {
      ...
      revealedUntilTick: this._revealedUntilTick,
  ...
  increaseLevel(): void {
    this._level++;
    if (
      [UnitType.MissileSilo, UnitType.SAMLauncher, UnitType.AABattery].includes(
        this.type(),
      )
    ) {
      this._missileTimerQueue.push(this.mg.ticks());
