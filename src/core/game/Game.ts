...
export enum GameMapType {
  ProceduralMegaWorld = "Procedural Mega World",
  World = "World",
...
export const mapCategories: Record<string, GameMapType[]> = {
  procedural: [GameMapType.ProceduralMegaWorld],
  continental: [
    GameMapType.World,
...
export enum ProceduralWorldSizePreset {
  Mega = "Mega",
  Vast = "Vast",
  Colossal = "Colossal",
}

export enum ProceduralLandmassStyle {
  Balanced = "Balanced",
  YoungWorld = "Young World",
  FracturedWorld = "Fractured World",
  WarTorn = "War Torn",
}

export enum ProceduralPerformancePreset {
  Quality = "Quality",
  Balanced = "Balanced",
...
export enum UnitType {
  ...
  FighterSquadron = "Fighter Squadron",
  BomberSquadron = "Bomber Squadron",
  Port = "Port",
  AtomBomb = "Atom Bomb",
...
export enum AirMissionType {
  ...
  EscortBombers = "Escort Bombers",
  InterceptEnemyAircraft = "Intercept Enemy Aircraft",
  StrategicBombing = "Strategic Bombing",
  CloseAirSupport = "Close Air Support",
  PortStrike = "Port Strike",
}

export enum AirMissionPhase {
  Ready = "Ready",
  Outbound = "Outbound",
...
export interface UnitParamsMap {
  ...
  [UnitType.FighterSquadron]: {
    ...
    missionPhase?: AirMissionPhase;
    missionTicksRemaining?: Tick;
    rearmCompleteTick?: Tick;
    targetTile?: TileRef;
  };
  ...
  [UnitType.AABattery]: Record<string, never>;

  [UnitType.RadarStation]: Record<string, never>;
...
export const isAttackMode = (value: unknown): value is AttackMode =>
  isEnumValue(AttackMode, value);
...
export interface Unit {
  ...
  setRevealedUntilTick(tick: Tick | undefined): void;
  ...
  // Aircraft
  airbaseId(): number | undefined;
  airMissionType(): AirMissionType | undefined;
  setAirMissionType(missionType: AirMissionType | undefined): void;
  airMissionPhase(): AirMissionPhase | undefined;
  setAirMissionPhase(phase: AirMissionPhase | undefined): void;
  airMissionTicksRemaining(): Tick | undefined;
  setAirMissionTicksRemaining(ticks: Tick | undefined): void;
  rearmCompleteTick(): Tick | undefined;
  setRearmCompleteTick(tick: Tick | undefined): void;
}
...
export interface Game extends GameMap {
  ...
  drainPackedSupplyUpdates(): Uint32Array | null;
  recordMotionPlan(record: MotionPlanRecord): void;
  drainPackedMotionPlans(): Uint32Array | null;
  recomputeSupplyIfNeeded(ticks: Tick): void;
  setWinner(winner: Player | Team, allPlayersStats: AllPlayersStats): void;
  getWinner(): Player | Team | null;
  config(): Config;
  isPaused(): boolean;
  setPaused(paused: boolean): void;
  suppressTile(tile: TileRef, duration: Tick): void;
  addAirSupportZone(
    owner: Player,
    tile: TileRef,
    radius: number,
  ...
  hasAirSupport(tile: TileRef, owner: Player): boolean;
  hasRadarCoverage(tile: TileRef, owner: Player): boolean;
  ...
  isSupplyReserveDepleted(tile: TileRef): boolean;
  playerSupplySummary(player: Player | PlayerID): SupplySummary;
}
