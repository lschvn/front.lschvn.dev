...
import {
  AIRBASE_CONSTRUCTION_TICKS,
  AIRBASE_COST,
  AIRBASE_OPERATIONAL_RANGE,
  AIRBASE_SQUADRON_CAPACITY,
  BOMBER_SQUADRON_COST,
  BOMBER_SQUADRON_HEALTH,
  FIGHTER_SQUADRON_COST,
  FIGHTER_SQUADRON_HEALTH,
} from "./AirBalance";
import {
  AA_BATTERY_CONSTRUCTION_TICKS,
  AA_BATTERY_COST,
  AA_BATTERY_COOLDOWN,
  AA_BATTERY_ENGAGEMENT_RANGE,
  RADAR_STATION_CONSTRUCTION_TICKS,
  RADAR_STATION_COST,
  RADAR_STATION_DETECTION_RADIUS,
} from "./AntiAirBalance";
...
import {
  ...
  SONAR_STATION_COST,
  SONAR_STATION_COST_CAP,
  SUBMARINE_COST,
  SUBMARINE_COST_CAP,
  SUBMARINE_MAX_HEALTH,
} from "./NavalStealthBalance";
...
export class DefaultConfig implements Config {
  ...
  airbaseSquadronCapacity(): number {
    ...
    switch (type) {
      ...
      case UnitType.Submarine:
        info = {
          cost: this.costWrapper(
            (numUnits: number) =>
              Math.min(SUBMARINE_COST_CAP, (numUnits + 1) * SUBMARINE_COST),
            UnitType.Submarine,
          ),
