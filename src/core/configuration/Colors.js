...
export const redTeamColors = generateTeamColors(red);
export const blueTeamColors = generateTeamColors(blue);
export const tealTeamColors = generateTeamColors(teal);
export const purpleTeamColors = generateTeamColors(purple);
export const yellowTeamColors = generateTeamColors(yellow);
export const orangeTeamColors = generateTeamColors(orange);
export const greenTeamColors = generateTeamColors(green);
export const botTeamColors = [botColor];
