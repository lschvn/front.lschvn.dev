...
export class PastelThemeDark extends PastelTheme {
    constructor() {
        super(...arguments);
        this.darkShore = colord("rgb(134,133,88)");
        this.darkWater = colord("rgb(14,11,30)");
        this.darkShorelineWater = colord("rgb(50,50,50)");
    }
...
//# sourceMappingURL=PastelThemeDark.js.map